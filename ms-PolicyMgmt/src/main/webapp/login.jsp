	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form p-l-55 p-r-55 p-t-178"  action="welcome" method="POST" >
					<span class="login100-form-title" style="font-size: 19px;"> 
					 ...
					 <!-- <div class="wrap-input100 validate-input m-b-16" data-validate="Please enter username"> --> 
						<div>
						<input class="input100" type="text" name="email" placeholder="E-mail" value="nvasdev">
						<span class="focus-input100"></span>
					</div>

					<!-- <div class="wrap-input100 validate-input" data-validate = "Please enter password"> -->
						<div>
						<input class="input100" type="password" name="pass" placeholder="Password" value="nvasdev">
						<span class="focus-input100"></span>
					</div>
					<br>
